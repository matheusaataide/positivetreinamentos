...
(function() {
  ...
  Uploader = (function(_super) {
    ...
    Uploader.prototype.opts = {
      ...
      params: null,
      connectionCount: 3,
      leaveConfirm: 'Upload de arquivo, se você deixar o upload, ele será cancelado automaticamente'
    };
...
(function() {
  ...
  UnderlineButton = (function(_super) {
    ...
    UnderlineButton.prototype.title = 'Sublinhado';
  ...
  OrderListButton = (function(_super) {
    ...
    OrderListButton.prototype.title = 'Lista numerada';
  ...
  UnorderListButton = (function(_super) {
    ...
    UnorderListButton.prototype.title = 'Lista comum';
  ...
  CodeButton = (function(_super) {
    ...
    CodeButton.prototype.title = 'Código';
  ...
  LinkButton = (function(_super) {
    ...
    LinkButton.prototype.title = 'Adicionar link';
    ...
    LinkButton.prototype.command = function() {
      ...
      if (this.active) {
        ...
        $link = $('<a/>', {
          href: 'http://www.exemplo.com',
          target: '_blank',
          text: linkText || 'Exemplo'
        });
  ...
  LinkPopover = (function(_super) {
    ...
    LinkPopover.prototype._tpl = "<div class=\"link-settings\">\n  <div class=\"settings-field\">\n    <label>Texto</label>\n    <input class=\"link-text\" type=\"text\"/>\n    <a class=\"btn-unlink\" href=\"javascript:;\" title=\"Remover link\" tabindex=\"-1\"><span class=\"fa fa-unlink\"></span></a>\n  </div>\n  <div class=\"settings-field\">\n    <label>URL</label>\n    <input class=\"link-url\" type=\"text\"/>\n  </div>\n</div>";
  ...
  ImageButton = (function(_super) {
    ...
    ImageButton.prototype.icon = 'image';

    ImageButton.prototype.title = 'Mídia';
    ...
    ImageButton.prototype.menu = [
      {
        name: 'upload-image',
        text: 'Enviar do computador'
      }, {
        name: 'external-image',
        text: 'Imagem externa via URL'
      }
    ];
    ...
    ImageButton.prototype._initUploader = function() {
      ...
      this.editor.uploader.on('beforeupload', function(e, file) {
        ...
        return _this.editor.uploader.readImageFile(file.obj, function(img) {
          ...
          prepare = function() {
            var $progress;
            _this.popover.srcEl.val('Carregando...');
  ...
  ImagePopover = (function(_super) {
    ...
    ImagePopover.prototype._initUploader = function() {
      ...
      createInput = function() {
        ...
        return _this.input = $('<input type="file" title="Upload" name="upload_file" accept="image/*">').appendTo($uploadBtn);
      };
      createInput();
  ...
  TableButton = (function(_super) {
    ...
    TableButton.prototype.title = 'Inserir tabela';
    ...
    TableButton.prototype.renderMenu = function() {
      var _this = this;
      $('<div class="menu-create-table">\n</div>\n<div class="menu-edit-table">\n  <ul>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteRow"><span>Excluir linha</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertRowAbove"><span>Inserir linha acima</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertRowBelow"><span>Inserir linha abaixo</span></a></li>\n    <li><span class="separator"></span></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteCol"><span>Excluir coluna</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertColLeft"><span>Inserir coluna à esquerda</span></a></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="insertColRight"><span>Inserir coluna à direita</span></a></li>\n    <li><span class="separator"></span></li>\n    <li><a tabindex="-1" unselectable="on" class="menu-item" href="javascript:;" data-param="deleteTable"><span>Excluir tabela</span></a></li>\n  </ul>\n</div>').appendTo(this.menuWrapper);
