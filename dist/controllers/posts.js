...
var PostController = function PostController(database) {
  return {
    list: function () {
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 10:
                ...
                if (post.photo !== null && post.photo !== "") {
                  _fs["default"].unlink(_path["default"].join(__dirname, '..', 'uploads', post.photo), function (err) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                posts = database.posts;
                newPost = _objectSpread(_objectSpread({}, req.body), {}, {
    ...
    edit: function () {
      var _edit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(req, res) {
        var posts, id, oldData, _yield$posts$update, _yield$posts$update2, flag, newData;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 8:
                ...
                _context5.next = 11;
                return posts.update(_objectSpread(_objectSpread(_objectSpread({}, oldData), req.body), {}, {
              ...
              case 11:
                _yield$posts$update = _context5.sent;
                _yield$posts$update2 = _slicedToArray(_yield$posts$update, 1);
                flag = _yield$posts$update2[0];
                _context5.next = 16;
                return posts.findByPk(id);
