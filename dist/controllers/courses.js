  ...
  return {
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 10:
                ...
                if (course.photo !== null && course.photo !== "") {
                  _fs["default"].unlink(_path["default"].join(__dirname, '..', 'uploads', course.photo), function (err) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                courses = database.courses;
                newCourse = _objectSpread(_objectSpread({}, req.body), {}, {
    ...
    edit: function () {
      var _edit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(req, res) {
        var courses, id, oldData, _yield$courses$update, _yield$courses$update2, flag, newData;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 8:
                ...
                _context5.next = 11;
                return courses.update(_objectSpread(_objectSpread(_objectSpread({}, oldData), req.body), {}, {
              ...
              case 11:
                _yield$courses$update = _context5.sent;
                _yield$courses$update2 = _slicedToArray(_yield$courses$update, 1);
                flag = _yield$courses$update2[0];
                _context5.next = 16;
                return courses.findByPk(id);
