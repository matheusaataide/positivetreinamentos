      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return queryInterface.createTable('transformations', {
                id: {
                  allowNull: false,
                  autoIncrement: true,
                  primaryKey: true,
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return queryInterface.dropTable('transformations');
...
//# sourceMappingURL=20210228101500-create-transformations.js.map